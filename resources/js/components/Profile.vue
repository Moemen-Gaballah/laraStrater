            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="card card-widget widget-user">
                  ...
                  <div class="widget-user-image">
                    <!-- <img class="img-circle" :src="'images/profile/'+form.photo" alt="User Avatar"> -->
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane" id="activity">
                    <!-- Post -->
                    <div class="post">
                        <p class="text-center">Display User Activity</p>
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="password" v-model="form.password" class="form-control" :class="{ 'is-invalid': form.errors.has('password') }" id="password" placeholder="Password not required but min 8 charaters">
